...
const routes: Routes = [
  ...
  { path: 'compras', component: ListCompraComponent, canActivate: [AdminGuard] },
  ...
  { path: 'detalleCompra',component: ListDetallecompraComponent, canActivate: [AdminGuard] },
  { path: 'detalleCompra-add', component: AddDetallecompraComponent, canActivate: [AdminGuard] },
  { path: 'detalleCompra-edit/:id', component: AddDetallecompraComponent, canActivate: [AdminGuard] },
  { path: 'profesionales', component: ListProfesionalesComponent, canActivate: [AdminGuard] },
  ...
  { path: 'recomendaciones', component: ListRecomendacionComponent, canActivate: [AdminGuard] },
  ...
  { path: 'seguimientos', component: ListSeguimientoComponent, canActivate: [AdminGuard] },
  ...
  { path: 'resena-add', component: AddResenaComponent, canActivate: [AdminGuard] },
  { path: 'resena-edit/:id', component: AddResenaComponent, canActivate: [AdminGuard] },
  { path: 'objetivosSalud', component: ListObjetivosaludComponent, canActivate: [AdminGuard] },
